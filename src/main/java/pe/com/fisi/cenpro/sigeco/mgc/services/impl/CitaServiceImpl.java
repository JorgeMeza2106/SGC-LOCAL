...
public class CitaServiceImpl implements CitaService {
	...
	/**
	 * M�todo que registra la cita, realiza todas las validaciones necesarias
	...
	/**
	 * Metodo que valida la fecha de atenci�n
	 * 
	 * @param fechaReserva
	 * @param fechaAtencion
	...
	/**
	 * M�todo que valida si la fecha de reserva se encuentra en el rango
	 * permitido de la fecha de atenci�n, en base al MAX y MIN de d�as de
	 * anticipaci�n permitidos
	 * 
	 * @param fechaReserva
	 * @param fechaAtencion
	 * @return una constante de ServiceConstants dependendiendo si la fecha de
	 *         reserva es valida o no y si se encuentra en el l�mite la cte.
	...
	/**
	 * M�todo que evalua si la hora esta antes del parametro definidio. No es
	...
	/**
	 * M�todo que solo verifica si una cita es adicional o no, es decir, si la
	 * fecha de reserva es la misma que la fecha de atenci�n.
	 * 
	 * @param fechaReserva
	 * @param fechaAtencion
    ...
    /**
     * Cancela una cita, verificando las condiciones de validaci�n
     * */
	@Transactional
	@Override
